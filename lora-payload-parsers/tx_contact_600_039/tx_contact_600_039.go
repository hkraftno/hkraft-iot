...
type Tx_Contact_600_039 struct {
	...
	PulseCh1          bool        `json:"pulse_ch1"`
	PulseCh2          bool        `json:"pulse_ch2"`
	PulseOC           bool        `json:"pulse_oc"`
...
func (t *Tx_Contact_600_039) Load(hexString string) error {
	...
	t.PulseCh1 = binary_utils.BytesToUint32(hexBytes[6:10]) == 1
	t.PulseCh2 = binary_utils.BytesToUint32(hexBytes[10:14]) == 1
	t.PulseOC = binary_utils.BytesToUint32(hexBytes[14:18]) == 1
...
func toAlarmStatus(hex []byte) AlarmStatus {
	/*
		{ name: "pulse_ch1", values: [{ change: false }, { change: true }], bit: 1 },
		{ name: "pulse_ch2", values: [{ change: false }, { change: true }], bit: 2 },
		{ name: "pulse_oc", values: [{ change: false }, { change: true }], bit: 3 },
	*/
