export default {
  ...
  <section class="section">
    <h1 class="title">Om Haugaland Kraft IoT</h1>
    <p class="subtitle">Om tjenesten</p>
    <p class="content">
    ...
    <p class="content">
      Ta kontakt på <a href="https://www.facebook.com/HaugalandKraft/">facebook</a> eller via tilbakemeldingsknappen på siden her, hvis det er noe du lurer på, er inspirert til å lage noe lignende selv eller bare vil gi en tilbakemelding
    <p class="subtitle">
