    ...
    return (
      <Paper elevation={4} className={classes.paper}>
        <Grid container alignItems="center" justify="center" >
          ...
          <Grid item xs={12}>
            <Typography variant="title" align="center" gutterBottom>Bade-Anna har tatt vinterferie.</Typography>
            <Typography align="center" gutterBottom>Bade-Anna har tatt en velfortjent vinterferie.</Typography>
          </Grid>
